...
import { Card, TextField, Button, Snackbar, Box } from "@mui/material";
...
export const PriceTotal: React.FC<{
  ...
  const subtotal = cartItems.reduce(
    (acc, item) => acc + item.product.b2bPrice * item.quantity,
    0
  );
  const vat = 40;
  ...
  return (
    ...
    >
      <div
        className="p-12 flex-col items-end text-lg font-bold mb-4 w-full sm:w-350px md:w-400px"
        style={{
          marginLeft: "auto",
        }}
      >
