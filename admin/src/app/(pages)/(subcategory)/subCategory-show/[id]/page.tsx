...
import SubCategoryShow from "@/components/organisms/SubCategoryShow";
...
const ShowSubCategory: React.FC<BaseEditProps> = ({ params }) => {
  ...
  return (
    <LoadingError loading={loading} error={error}>
      <div className="flex justify-end mt-5">
        <Link href={`/subCategory-list/${params.id}`}>
          <Button
            variant="contained"
            startIcon={<EditIcon />}
      ...
      >
        <>
          {data ? <SubCategoryShow data={data} /> : <p>No data available.</p>}
        </>
